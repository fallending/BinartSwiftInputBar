...
@implementation UIView ( BAAutoLayout )
...
- (ContentCompressionResistancePriority)whc_ContentCompressionResistancePriority {
    __weak typeof(self) weakSelf = self;
    return ^(UILayoutPriority priority, UILayoutConstraintAxis axis) {
...
- (UIView *)whc_HandleConstraintsRelation:(NSLayoutRelation)relation {
...
- (UIView *)whc_AutoHeight:(CGFloat)left top:(CGFloat)top width:(CGFloat)width bottom:(CGFloat)bottom toView:(NSObject *)toView {
    [self whc_LeftSpace:left toView:toView];
    [self whc_TopSpace:top toView:toView];
    [self whc_Width:width];
    return [self whc_BottomSpace:bottom toView:toView];
...
- (UIView *)whc_ConstraintWithItem:(NSObject *)item
...
- (UIView *)mainSuperView:(NSObject *)view1 view2:(NSObject *)view2 {
    ...
    - (UIView *)scanSubv:(NSArray<UIView *> *)subvs sbvspv:(UIView *)sbvspv {
        UIView * tempSuperView;
...
- (WHC_Data *)sameSuperviewWithView1:(NSObject *)view1 view2:(NSObject *)view2 {
