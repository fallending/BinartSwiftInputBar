...
@protocol BAAnimatedImageViewDebugDelegate;


//
//  An `BAAnimatedImageView` can take an `BAAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
//
@interface BAAnimatedImageView : UIImageView
...
@property (nonatomic, strong) BAAnimatedImage *animatedImage;
