...
- (void)changeKeyboardTo:(PPKeyboardType)toType {
    ...
    switch (toType) {
        case PPKeyboardTypeNone:
            [self.emojiToggleButton setImage:BAStickerConfig.shared.toggleEmoji forState:UIControlStateNormal];
        ...
        case PPKeyboardTypeSticker:            
            [self.emojiToggleButton setImage:BAStickerConfig.shared.toggleKeyboard forState:UIControlStateNormal];
...
- (PPButton *)emojiToggleButton {
    if (!_emojiToggleButton) {
        ...
        [_emojiToggleButton setImage:BAStickerConfig.shared.toggleEmoji forState:UIControlStateNormal];
...
- (void)refreshTextUI {
    ...
    // 匹配表情
    [BAStickerConfig.shared replaceEmojiForAttributedString:attributedComment font:[UIFont systemFontOfSize:PPStickerTextViewFontSize]];
