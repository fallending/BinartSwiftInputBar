...
static CGFloat const PPSlideLineWidth = 2.0;
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.lineWidth = PPSlideLineWidth;
        self.lineHeight = PPSlideLineHeight;
    }
    return self;
}
...
- (void)layoutSubviews {
    ...
    UIView *leftLine = [[UIView alloc] initWithFrame:CGRectMake(0, (CGRectGetHeight(self.bounds) - _lineHeight) / 2, PPOnePixelToPoint(_lineWidth), _lineHeight)];
    leftLine.backgroundColor = self.lineColor;
    UIView *rightLine = [[UIView alloc] initWithFrame:CGRectMake(CGRectGetWidth(self.bounds) - PPOnePixelToPoint(_lineWidth), (CGRectGetHeight(self.bounds) - _lineHeight) / 2, PPOnePixelToPoint(_lineWidth), _lineHeight)];
